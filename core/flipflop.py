...
class DFlipFlop:
    ...
    Behavior:
      ...
      - If a rising edge (0->1) is detected on CLK this tick, sample D into next_q.
      - Effect: Q updates one simulation step after the rising edge.
    """
    ...
    def tick(self):
        """Advance one simulation step for the FF."""
